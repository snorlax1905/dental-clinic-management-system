...
<form action="appointement.php" method="post" class="form">
      ...
      <?php
     $link=mysqli_connect("localhost", "root","","dentalclinic") or die("Connection Failed");
      mysqli_select_db($link,"dentalclinic")or die("Connection Failed");
      ...
      <label>Time:</label> <select name="time" id="hall" value="<?php if (isset($_POST['time'])) echo $_POST['time']; ?>" >
        ...
        <option>5 PM</option>
        <option>6 PM</option>
        <option>7 PM</option>  <!-- time for 24 hours -->
      </select>
      <br>
      <br>
